  ...
  return (
    <div className="px-4 pb-8">
      ...
      <p className="mt-4 px-1 text-[13px] leading-relaxed text-muted">
        Счета нужны, чтобы видеть не только «сколько всего», но и «где именно». Остаток на любом
        из них правится вручную: откройте счёт и поставьте то число, которое показывает банк, —
        история операций от этого не изменится.
      </p>

      <p className="mt-2 px-1 text-[13px] leading-relaxed text-muted">
        Операции счёт не требуют. Общие траты можно заводить без него — они попадут в историю и в
        аналитику, но остатки не тронут. Привязали операцию к счёту — она этот остаток изменит, а
        перемещение денег между своими счетами заводится переводом: тогда снятие наличных не
        выглядит тратой в тридцать тысяч, а пополнение вклада не портит структуру расходов.
      </p>
